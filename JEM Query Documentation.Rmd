...
The HUC boundaries can be obtained online from [USGS National Hydrography Dataset](ftp://rockyftp.cr.usgs.gov/vdelivery/Datasets/Staged/Hydrography/WBD/HU2/Shape/) (in event that user does not have access to Water49), but have also been placed into www/ subdirectory for easy access.
